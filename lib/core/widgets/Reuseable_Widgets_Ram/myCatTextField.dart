...
class MyTextField extends StatelessWidget {
  ...
  MyTextField(
      ...
      this.borderradios = null,
      this.hintTextColor = Colors.black54,
      this.enabled = true,
      required this.addDecaration,
      this.textEditingController = null,
      this.hint_text = null,
      this.text_input_type = TextInputType.emailAddress,
      required this.is_password,
      this.decoration_degree = 12,
      this.borderSide_color = Colors.red,
      this.borderSide_color_infocas = Colors.green,
      this.textAlign = TextAlign.left})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    var nradios = borderradios == null
    ...
    return Container(
        ...
        child: TextField(
          ...
          decoration: my_TextField_decoration(
              ...
              decoration_degree,
              borderSide_color,
              borderSide_color_infocas,
              addDecaration),
        )
        //   .copyWith(
        // contentPadding: EdgeInsets.symmetric(horizontal: 10), // Adjust the padding as needed
        // hintText: hint_text,
        // hintStyle: const TextStyle(textAlign: TextAlign.left),
        // ),
        );
  }
}
